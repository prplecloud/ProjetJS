INSERT INTO `products`(`name`, `price`, `stock`, `image_url`,`image_url2`, `description`, `réduction`, `edition_id`, `licence_id`, `state_id`, `langage_id`, `categories_id`) 
VALUES 
("Pokémon - Coffret - Motorizard Ex", 29.90, 3, 
"assets/img/articles/Pokemon/coffrets/coffret-1-2.jpg", "assets/img/articles/Pokemon/coffrets/coffret-1-3.jpg",
"Arrivez en roue libre à votre prochain match du JCC Pokémon avec le soutien de Motorizard-ex !
...
("Pokémon - The Pokémon Company - Coffret - Dogrino Ex", 22.90, 2, 
"assets/img/articles/Pokemon/coffrets/coffret-2-2.jpg", "assets/img/articles/Pokemon/coffrets/coffret-2-3.jpg",
"Dogrino est doux en général, mais lorsqu’il doit protéger ses alliés, il prend un air menaçant. Faites équipe avec ce Pokémon loyal et lancez des attaquespuissantes qui décourageront vos adversaires ! Vous trouverez Dogrino-ex en tant que carte promo brillante en version pour le jeu et grand format, ainsiqu’une carte de Grondogue, le Pokémon Jeunot.
Contenu :
...
("Pokémon - Coffret - EV05 Ecarlate et Violet - Forces Temporelles - Dresseur d'Elite : Serpente-Eau", 54.90, 2, 
...
"Les rangs des Pokémon Temps passé et Temps futur continuent de grossir.
...
", 54.90, 2, 
"assets/img/articles/Pokemon/coffrets/Vert-de-Fer.jpg",  "assets/img/articles/Pokemon/coffrets/Vert-de-Fer2.jpg",
"Les rangs des Pokémon Temps passé et Temps futur continuent de grossir.
Serpente-Eau-ex se libère des chaînes du passé aux côtés d’Ire-Foudre-ex, tandis que Vert-de-Fer-ex impose une justice high-tech avec Chef-de-Fer-ex.
À l’extérieur de la Zone Zéro, Triopikeau et Farigiraf changent de type en tant que Pokémon-ex Téracristal, et les Dresseurs et Dresseuses Pokémon du monde entier se préparent pour le retour des cartes HIGH-TECH aux effets puissants et uniques.
Une brèche temporelle s’est ouverte, amenant avec elle des bêtes sauvages et des créatures futuristes dans l’extension Écarlate et Violet – Forces Temporelles du JCC Pokémon !
...
("Bheddi Boîte de Rangement compatible avec YGO TCG Cartes-Peut contenir jusqu'à 110 Cartes-Vec 2 Intercalaires-pour le rangement de jeux de cartes (Forbidden One)(Noir)", 15.99, 5, 
"assets/img/articles/Yu-Gi-Oh/Accessoires/boite1.jpg", "assets/img/articles/Yu-Gi-Oh/Accessoires/boite2.jpg",
"🌈 Capacité de stockage : Peut contenir jusqu'à 110 cartes à pochette simple / 80 cartes à double pochette / 200 cartes sans pochettes / Non compatible avec les chargeurs supérieurs, dimension de la boîte de jeu de cartes : env. 3 x 3 x 4 pouces / 77 x 77 x 102 mm
